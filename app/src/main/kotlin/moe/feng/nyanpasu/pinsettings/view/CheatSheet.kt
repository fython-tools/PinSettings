package moe.feng.nyanpasu.pinsettings.view
...
object CheatSheet {
	 ...
	 */
	fun setup(view: View) {
		view.setOnLongClickListener { showCheatSheet(it, it.contentDescription) }
	}
	...
	private fun showCheatSheet(view: View, text: CharSequence): Boolean {
		...
		val cheatSheet = ToastUtils.makeText(context, text, Toast.LENGTH_SHORT)
